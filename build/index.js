...
var require_loupe = __commonJS({
  "node_modules/loupe/loupe.js"(exports, module) {
    (function(global, factory) {
      ...
      function truncate2(string, length) {
      ...
      function inspectTypedArray(array, options) {
        ...
        for (var i = 0; i < array.length; i++) {
          var string = "".concat(options.stylize(truncate2(array[i], options.truncate), "number")).concat(i === array.length - 1 ? "" : ", ");
      ...
      function inspectDate(dateObject, options) {
        ...
        var date = split[0];
        return options.stylize("".concat(date, "T").concat(truncate2(split[1], options.truncate - date.length - 1)), "date");
      }
      function inspectFunction(func, options) {
        ...
        return options.stylize("[Function ".concat(truncate2(name, options.truncate - 11), "]"), "special");
      }
      ...
      function inspectNumber(number, options) {
        ...
        return options.stylize(truncate2(number, options.truncate), "number");
      }
      function inspectBigInt(number, options) {
        var nums = truncate2(number.toString(), options.truncate - 1);
        if (nums !== truncator)
          nums += "n";
      ...
      function inspectRegExp(value, options) {
        ...
        return options.stylize("/".concat(truncate2(source, sourceLength), "/").concat(flags), "regexp");
      }
      ...
      function inspectString(string, options) {
        ...
        return options.stylize("'".concat(truncate2(string, options.truncate - 2), "'"), "string");
      }
      ...
      function inspectHTML(element, options) {
        ...
        var truncate3 = options.truncate;
...
// src/utils/string.ts
var truncate = (str = "", len = 250) => {
  return str.length > len ? `${str.substring(0, len)}...` : str;
};

// src/assert.ts
var customAssertCheck = null;
function assertCheck(val, sets, tags) {
...
var truncateByVariableThreshold = (str) => {
  return truncate(str, config_default.config.truncateVariableThreshold);
};
